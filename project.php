<?php
	...
	{
		$status = $_GET['status'];
		$sql = "SELECT `project name`, `client name`, `client no`, `p_amnt`, `prdate`, `pddate`, `status` FROM `project` WHERE `id`='$id'";
...
<div class="container mt-2 mb-2">
	<a href="project.php" class="btn btn-primary">BACK</a></br></br>
